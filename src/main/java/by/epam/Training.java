...
public class Training {
    public static void main(String[] args){
        ...
        System.out.println("------------------------------------");
        // Пример от преп. Эпам с измененным n на n1, т.к. у меня здесь уже была переменная n.
    ...
    static int getRange(int[] values) { // изменил возвращаемый тип на int
        ...
        System.out.println("min: " + min);  // игрался с примерами преп.: добавил вывод min и max элементов.
