...
public class BusinessTrip {
    ...
    public String getTotal() {
        return getPriceInByn((DAILY_RATE * days)+ transportExpenses);
    }
    private String getPriceInByn(int sum) {
    ...
    public void show() {
        ...
        System.out.println("transportExpenses expenses= " + getPriceInByn(transportExpenses));
        System.out.println("days = " + days);
    }

    @Override
    public String toString() {
        return account  + ";" + days + ";" + transportExpenses *0.01 + ";" + getTotal();
    }
}
